...
- 思路1：DFS BFS
- 思路2：并查集
  - https://labuladong.gitbook.io/algo/mu-lu-ye-1/mu-lu-ye-2/unionfind-suan-fa-ying-yong


> 题目
<div align="center" style="zoom:80%"><img src="./pic/130-1.png"></div>
...
public:
    void solve(vector<vector<char>>& board) {
        ...
        const int FLAG = sizeX*sizeY;   // 该点为一个特殊的界外点
        // 上下边界
